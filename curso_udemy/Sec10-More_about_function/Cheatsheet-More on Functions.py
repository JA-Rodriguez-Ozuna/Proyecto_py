...
def cuboid_volume(a, b, c=10):
    return a * b * c
print(cuboid_volume(2, b=3)) # 60
'''
1.a and b are non-default parameters, c is a default parameter.
2. 2 is non-keyword (positional)argument, b=3 is a keyword argument.
'''